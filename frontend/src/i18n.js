    ...
    translation: {
      auth: {
        signup: {
          ...
          subtitle: 'Deposit, deploy bots, and trade — no KYC needed until your first withdrawal.',
          submit: 'Sign up',
      ...
      deposit: {
        ...
        watchingNotice: "We're watching this address closely for the next 10 minutes. A late deposit is never lost — it's picked up by a backstop check within 12 hours.",
      ...
      withdraw: {
        ...
        kycRequiredBody: 'Withdrawals are locked until your KYC is approved. Deposits, bots, and trading all still work in the meantime.',
        ...
        successBody: "Your request is pending admin approval — you'll see it update below once it's reviewed.",
      ...
      kyc: {
        ...
        backHome: 'Back',
        intro: "Verification is required before your first withdrawal — deposits, bots, and trading all work without it. Upload a government ID (front and back) and a selfie; a reviewer typically responds within a few days.",
        ...
        approvedBody: "You're verified — withdrawals are unlocked.",
      ...
      bots: {
        ...
        create: {
          ...
          cardBody: 'Runs trading sessions on a schedule — wins and losses move your real USDT balance based on live market conditions.',
          pairLabel: 'Pair',
          ...
          sessionLengthHint: 'Longer sessions trade real chart realism for a longer-running bot — sessions over 30 min use a synthetic price chart instead of real market history.',
          submit: 'Create bot',
          creating: 'Creating…',
          confirmTitle: 'Confirm allocation',
          confirmBody: 'You’re about to move this amount from your available balance into the bot. Review it before continuing.',
      ...
      markets: {
        ...
        loadError: "Couldn't load market data — is the market_data_feed worker running?",
      ...
      trade: {
        ...
        noPrice: 'Waiting for a live price…',
      ...
      convert: {
        title: 'Convert',
        simulatedNotice: 'Simulated execution — real balance. Converting never touches a real exchange, but it moves your real USDT and asset balances at the live market price, including a {{feePct}} fee.',
