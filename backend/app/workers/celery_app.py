...
celery_app.conf.beat_schedule = {
    "deposit-sweep": {
        ...
        # Twice daily per the architecture doc — this is the unconditional
        # backstop, not the fast path. A future live/session watcher (built
        # alongside the Deposit screen) will catch most deposits well before
        # this ever runs.
