    ...
    translation: {
      ...
      wallet: {
        ...
        activityTypes: {
          ...
          SIMULATED_BOT_PROFIT: 'Bot profit',
          SIMULATED_BOT_LOSS: 'Bot loss',
        },
      },
      deposit: {
        title: 'Deposit',
      ...
      withdraw: {
        ...
        notWithdrawableBody: "{{asset}} can't be withdrawn directly ~ it's only tradeable on Quantex right now. Sell it back to USDT on the Trade screen, then withdraw USDT instead.",
        tradeLink: 'Go to Trade',
        feeAmount: 'Amount',
        feeFee: 'Network fee',
      ...
      bots: {
        ...
        create: {
          ...
          success: 'Bot created.',
          dailyLimitReached: 'You’ve used all {{limit}} bot sessions for today. Resets in {{hours}} hour(s).',
        },
      },
      admin: {
        nav: {
