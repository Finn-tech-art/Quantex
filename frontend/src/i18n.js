...
const resources = {
  en: {
    translation: {
      ...
      // NOTE: the `admin` translation block used to live here. It's been
      // moved out to src/i18n/admin-en.js and is loaded on demand — merged
      // into i18next only when an admin page's chunk loads — instead of
      // shipping in every visitor's initial bundle. See that file's header
      // comment and the admin lazy() imports in App.jsx for how the two
      // connect. Add new admin.* keys there, not here.
